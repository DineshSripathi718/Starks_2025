...
if(weatherAppData.cityName){
    fetchWeatherData(weatherAppData.cityName);
}
...
function showWeatherCard({name, main, weather, wind, sys}, weatherIcon){
            ...
            <div class="humidity-title-container">
                ...
                <div class="humidity-details">
                    <div class="circular-progress" 
                        ...
                        data-percentage="${main.humidity}" 
                        data-progress-color="#ff7300" 
                        data-bg-color="black">
                        <div class="inner-circle"></div>
                        <div class="percentage">${main.humidity}%</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="extra-weather-details">
            ...
            <div class="wind-info">
                <div class="wind-arrow-container">
                    <img id="wind-arrow" src="./assets/images/arrow.png" style="transform: rotate(${wind.deg}deg);" />
                </div>
                <div class="wind">
    ...
    const countryButton = document.getElementById('country-info');
    countryButton.addEventListener('click', () => {
        weatherAppData.cityName = name;
        weatherAppData.countryCode = sys.country;
        localStorage.setItem("weatherAppData", JSON.stringify(weatherAppData));
        window.location.href = "./countries.html";
    });

    // Initialize circular animation *after* DOM is updated
    setTimeout(() => {
